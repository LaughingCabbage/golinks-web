				...
				<div class="tab-content" id="missionTabContent">
					<div class="tab-pane fade show active" id="who" role="tabpanel" aria-labelledby="who-tab">
						<div class="card-body">
							...
							<p class="card-text">
								We are GoVice.org founded by Kevin Gentile in 2018. Our organization is focused on building systems that help maintain the
								integrity of information used by researchers, buisnesses, and everyday people in the digital age.
							</p>
